...
alter table beds_assigned_to_shift add constraint fk_bats_bed foreign key (beds_bed_id) references beds(bed_id);

alter table beds_assigned_to_shift add constraint fk_bats_bedloc foreign key (beds_location_id) references beds(Location_Location_ID);
