...
-- Schema OAMC_2.6
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `OAMC_2.6` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `OAMC_2.6` ;

-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Unit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Unit` (
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Employee_Type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Employee_Type` (
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Employee`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Employee` (
  ...
  CONSTRAINT `fk_Employee_Unit`
    FOREIGN KEY (`Unit_ID`)
    REFERENCES `OAMC_2.6`.`Unit` (`Unit_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Employee_Employee_Type1`
    FOREIGN KEY (`Employee_Type_ID`)
    REFERENCES `OAMC_2.6`.`Employee_Type` (`Employee_Type_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Service_Type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Service_Type` (
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Employee_Service`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Employee_Service` (
  `Service_ID` INT NOT NULL COMMENT '',
  `Employee_ID` INT NOT NULL COMMENT '',
  ...
  CONSTRAINT `fk_Employee_Services_Employee1`
    ...
    REFERENCES `OAMC_2.6`.`Employee` (`Employee_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Employee_Services_Service_Type1`
    FOREIGN KEY (`Service_ID`)
    REFERENCES `OAMC_2.6`.`Service_Type` (`Service_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Patient`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Patient` (
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Location`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Location` (
  `Unit_ID` INT NOT NULL COMMENT '',
  ...
  UNIQUE INDEX `Room_UNIQUE` (`Room` ASC)  COMMENT '',
...
-- Table `OAMC_2.6`.`Bed`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Bed` (
  `Bed_ID` INT NOT NULL COMMENT '',
  `Patient_ID` INT NULL COMMENT '',
  `Location_ID` INT NOT NULL COMMENT '',
  PRIMARY KEY (`Bed_ID`, `Location_ID`)  COMMENT '',
  ...
  CONSTRAINT `fk_Beds_Location1`
    ...
    REFERENCES `OAMC_2.6`.`Location` (`Location_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Beds_Patient1`
    FOREIGN KEY (`Patient_ID`)
    REFERENCES `OAMC_2.6`.`Patient` (`Patient_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Treatment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Treatment` (
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Treatment_Instance`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Treatment_Instance` (
  ...
  CONSTRAINT `fk_Patient_Treatment_Instances_Treatment1`
    ...
    REFERENCES `OAMC_2.6`.`Treatment` (`Treatment_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Supply`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Supply` (
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Carrier`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Carrier` (
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Vendor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Vendor` (
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Order`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Order` (
  `Order_ID` INT NOT NULL COMMENT '',
  `Date` DATE NULL COMMENT '',
  `Carrier_ID` INT NOT NULL COMMENT '',
  `Vendor_ID` INT NOT NULL COMMENT '',
  `Rush?` TINYINT(1) NULL COMMENT '',
  PRIMARY KEY (`Order_ID`, `Carrier_ID`, `Vendor_ID`)  COMMENT '',
  ...
  CONSTRAINT `fk_Order_Carrier1`
    ...
    REFERENCES `OAMC_2.6`.`Carrier` (`Carrier_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Order_Vendors1`
    FOREIGN KEY (`Vendor_ID`)
    REFERENCES `OAMC_2.6`.`Vendor` (`Vendor_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Order_Detail`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Order_Detail` (
  ...
  CONSTRAINT `fk_Order_Details_Order1`
    ...
    REFERENCES `OAMC_2.6`.`Order` (`Order_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Order_Details_Supplies1`
    FOREIGN KEY (`Supply_ID`)
    REFERENCES `OAMC_2.6`.`Supply` (`Internal_Supply_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Room_Supply`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Room_Supply` (
  `Quantity` INT NOT NULL COMMENT '',
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Employee_Schedule`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Employee_Schedule` (
  `Employee_ID` INT NOT NULL COMMENT '',
  `Treatment_Instance_ID` INT NOT NULL COMMENT '',
  PRIMARY KEY (`Employee_ID`, `Treatment_Instance_ID`)  COMMENT '',
  INDEX `fk_Employee_has_Patient_Treatment_Instances_Patient_Treatme_idx` (`Treatment_Instance_ID` ASC)  COMMENT '',
  INDEX `fk_Employee_has_Patient_Treatment_Instances_Employee1_idx` (`Employee_ID` ASC)  COMMENT '',
  ...
  CONSTRAINT `fk_Employee_has_Patient_Treatment_Instances_Patient_Treatment1`
    FOREIGN KEY (`Treatment_Instance_ID`)
    REFERENCES `OAMC_2.6`.`Treatment_Instance` (`Instance_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Treatment_Staff`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Treatment_Staff` (
  `Employee_Type_ID` INT NOT NULL COMMENT '',
  `Treatment_ID` INT NOT NULL COMMENT '',
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Treatment_Supply`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Treatment_Supply` (
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Shift_Type`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Shift_Type` (
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Assigned_Shift`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Assigned_Shift` (
  ...
  CONSTRAINT `fk_Shift_has_Employee_Shift1`
    ...
    REFERENCES `OAMC_2.6`.`Shift_Type` (`Shift_Type_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Bed_Assigned_to_Shift`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Bed_Assigned_to_Shift` (
  `Bed_ID` INT NOT NULL COMMENT '',
  `Shift_ID` INT NOT NULL COMMENT '',
  ...
  CONSTRAINT `fk_Beds_has_Assigned_Shift_Beds1`
    FOREIGN KEY (`Bed_ID`)
    REFERENCES `OAMC_2.6`.`Bed` (`Bed_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Beds_has_Assigned_Shift_Assigned_Shift1`
    FOREIGN KEY (`Shift_ID`)
    REFERENCES `OAMC_2.6`.`Assigned_Shift` (`Shift_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Doctor_Rotation`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Doctor_Rotation` (
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Visit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Visit` (
...
-- -----------------------------------------------------
-- Table `OAMC_2.6`.`Treatment_History`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `OAMC_2.6`.`Treatment_History` (
  `Patient_Treatment_ID` INT NOT NULL COMMENT '',
  `Visit_ID` INT NOT NULL COMMENT '',
  ...
  CONSTRAINT `fk_Patient_Treatment_Instances_has_Visits (or Patient History2`
    ...
    REFERENCES `OAMC_2.6`.`Visit` (`Visit_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
